...
L = [f"/* platform/pc/src/pc_unit_anim_data.c -- GENERATED by platform/pc/tools/gen_unit_anim_data.py",
     f" * (region '{REGION}', from {BASENAME}). Reconstructed gUnitAnimSets: the three-level per-unit",
     " * animation table (set pointer -> per-AnimIdx anim-pointer array -> self-terminating byte",
     " * strips, parsed by src/core/object.c UpdateUnitSpriteAnimation). PC data-gen leaves",
     " * pointer-typed globals NULL, so every level is extracted from the byte-exact executable and",
     " * relocated to local symbols; deduplicated sub-arrays (one address shared by several units)",
     " * and genuinely-NULL slots are preserved as-is. Sized [489] not [144]: SetupSprites indexes",
     " * past 143 -- rationale in include/graphics.h at the PERMUTER-gated extern. DO NOT hand-edit;",
     " * rerun the generator. Stage-2 PC data only; not in the matching build. */",
     '#include "graphics.h"', "", ""]
