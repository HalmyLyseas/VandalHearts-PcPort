...
Region parameterisation (exchange/102 P1): VH_REGION ('us' default | 'jp'), VH_GAME_ROOT,
...
def main():
    ...
    L = ["/* GENERATED by platform/pc/tools/gen_sprite_box_quads.py -- do not edit by hand.",
         " * Reconstructed gSpriteBoxQuads[%d] (zero-filled by the data generator: pointer-typed)." % COUNT,
         " * Entries that are named live gQuad_* globals point at THE LIVE GLOBAL, not a frozen",
         " * blob copy (frozen-live-global class, feedback-25): on hardware they are the same",
         " * object, and per-frame by-name writes must reach what the renderer reads.",
         " * NOT const: the game rotates targeted Quads in place (core/object.c) and reassigns",
         " * entries between Quad sources (units/actor.c, spells/*, maps/map_28_31.c). */",
         '#include "graphics.h"', "",
