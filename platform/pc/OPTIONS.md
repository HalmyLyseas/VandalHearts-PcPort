...
| `VH_ACCURATE` | `1` | PSX-accurate software rasterizer (round-to-nearest UV, ordered dithering, 5-bit semi-transparency blend). On by default — the hardware-faithful, intended look. `0` = legacy renderer (no dithering, slightly softer); advanced users only. |
