...
void ShowReceivedItemDialog(u8 item, u8 windowId, u8 param_3) {
   ...
   len = GetItemNameLength(item) & 0xff;
   ...
   DrawWindow(windowId, 0, 0, width * 8, 36, 160 - width * 4, 90, WBS_CROSSED, 0);
   DrawText(16, 11, 25, 2, 0, gItemNamesSjis[item]);
   if (param_3 == 0) {
      /* を獲得しました。 */
      DrawText(16 + len * 12, 11, 25, 2, 0,
               "\x82\xf0\x8a\x6c\x93\xbe\x82\xb5\x82\xdc\x82\xb5\x82\xbd\x81\x42");
   } else {
      /* を発見しました！ */
      DrawText(16 + len * 12, 11, 25, 2, 0,
               "\x82\xf0\x94\xad\x8c\xa9\x82\xb5\x82\xdc\x82\xb5\x82\xbd\x81\x49");
   }
...
void ShowDepotReceivedItemDialog(u8 item, u8 windowId, u8 param_3) {
   ...
   DrawWindow(windowId, 0, 0, 240, 54, 40, 80, WBS_CROSSED, 0);
   DrawText(16, 11, 25, 2, 0, gItemNamesSjis[item]);
   len = GetItemNameLength(item) & 0xff;
   if (param_3 == 0) {
      /* を獲得しました。 */
   ...
   /* 持物がいっぱいなので倉庫に送ります。 */
   DrawText(16, 29, 25, 2, 0,
            "\x8e\x9d\x95\xa8\x82\xaa\x82\xa2\x82\xc1\x82\xcf\x82\xa2\x82\xc8\x82\xcc\x82\xc5"
            "\x91\x71\x8c\xc9\x82\xc9\x91\x97\x82\xe8\x82\xdc\x82\xb7\x81\x42");
...
void Objf597_BattleIntro(Object *obj) {
   ...
   case 1:
      if (--OBJ.timer == 0) {
         ...
         DrawWindow(0x42, 0, 0, 296, 72, 330, 80, WBS_DRAGON, 0);
         DrawText(20, 20, 30, 2, 0, gState.currentTextPointers[0]);
         DisplayBasicWindow(0x42);
         DisplayBasicWindow(0x43);
         SlideWindowTo(0x42, 12, 80);
         SlideWindowTo(0x43, 260, 80);
         OBJ.timer = 80;
         obj->state++;
      }
      break;
   ...
   case 4:
      if (--OBJ.timer == 0) {
         DrawWindow(0x42, 0, 0, 112, 64, 100, 90, WBS_DRAGON, 0);
         DrawText(20, 24, 20, 0, 0, "\x81\x40\x90\xed\x93\xac\x8a\x4a\x8e\x6e" /* 　戦闘開始 */);
...
void Objf003_BattleActions(Object *obj) {
   ...
   case 1:
      ...
      DrawWindow(0x35, 316, 0, 48, 90, 115, 80, WBS_CROSSED, 4);
      DrawText(320, 11, 2, 2, 0, "\x8d\x73\x93\xae\x8f\x49\x97\xb9\x92\x54\x8d\xf5\x89\x9f\x82\xb7" /* 行動終了探索押す */);
   ...
   case 7:
      ...
      switch (obj->state2) {
      case 0:
         DrawWindow(0x34, 316, 0, 48, 36, 10, 152, WBS_CROSSED, 0);
         DrawText(320, 11, 25, 0, 0, "\x88\xda\x93\xae" /* 移動 */);
      ...
      case 5:
         ...
         if (gState.signal == 0) {
            if (OBJ.timer < 20 && s_hiddenItem_801231f0 == ITEM_NULL) {
               gClearSavedPadState = 1;
               DrawWindow(0x3c, 0, 0, 176, 36, 72, 90, WBS_CROSSED, 0);
               DrawText(12, 11, 25, 2, 0, "\x89\xbd\x82\xe0\x94\xad\x8c\xa9\x82\xc5\x82\xab\x82\xdc\x82\xb9\x82\xf1\x82\xc5\x82\xb5\x82\xbd\x81\x42" /* 何も発見できませんでした。 */);
   ...
   case 10:
      ...
      case 0:
         gWindowChoiceHeight = 17;
         gWindowChoicesTopMargin = 10;
         DrawWindow(0x36, 316, 0, 48, 72, 115, 80, WBS_CROSSED, 3);
         DrawText(320, 11, 2, 2, 0, "\x8d\x55\x8c\x82\x96\x82\x96\x40\x8e\x9d\x95\xa8" /* 攻撃魔法持物 */);
   ...
   case 11:
      ...
      case 0:
         gWindowChoiceHeight = 17;
         gWindowChoicesTopMargin = 10;
         DrawWindow(0x37, 316, 0, 48, 54, 150, 100, WBS_CROSSED, 2);
         DrawText(320, 11, 2, 2, 0, "\x8d\x55\x8c\x82\x8e\x9d\x95\xa8" /* 攻撃持物 */);
   ...
   BattleActions_State16:
      ...
      case 0:
         ...
         gWindowChoicesTopMargin = 10;
         DrawWindow(0x35, 316, 0, 48, 108, 115, 60, WBS_CROSSED, 5);
         DrawText(320, 11, 2, 2, 0, "\x88\xda\x93\xae\x8d\x73\x93\xae\x8f\x49\x97\xb9\x92\x54\x8d\xf5\x89\x9f\x82\xb7" /* 移動行動終了探索押す */);
         DisplayBasicWindow(0x35);
         gWindowActiveIdx = 0x35;
         gClearSavedPadState = 1;
         obj->state2++;
...
void Objf425_BattleOptions(Object *obj) {
   ...
   case 1:
      gWindowChoiceHeight = 17;
      gWindowChoicesTopMargin = 10;
      DrawWindow(0x34, 0, 0, 88, 144, 112, 50, WBS_CROSSED, 7);
      DrawText(12, 11, 10, 2, 0,
               "\x83\x4e\x83\x8a\x83\x41\x8f\xf0\x8c\x8f\x0a\x83\x5e\x81\x5b\x83\x93\x8f\x49\x97\xb9\x0a\x83\x59\x81\x5b\x83\x80\x95\xcf\x8d\x58\x0a\x83\x58\x83\x65\x81\x5b\x83\x5e\x83\x58\x0a\x90\xdd\x92\xe8\x0a\x83\x5a\x81\x5b\x83\x75\x0a\x83\x8d\x81\x5b\x83\x68" /* クリア条件〜ロード */);
   ...
   case 5:
      ...
      switch (obj->state2) {
      case 0:
         DrawWindow(0x34, 256, 0, 64, 74, 115, 80, WBS_CROSSED, 3);
         DrawText(260, 11, 10, 2, 0, "\x8b\xdf\x8b\x97\x97\xa3\x0a\x92\x86\x8b\x97\x97\xa3\x0a\x89\x93\x8b\x97\x97\xa3" /* 近距離　中距離　遠距離 */);
   ...
   case 6:
      ...
      switch (obj->state2) {
      case 0:
         DrawWindow(0x34, 0, 0, 296, 72, 12, 80, WBS_DRAGON, 0);
         DrawText(20, 20, 30, 2, 0, gState.currentTextPointers[0]);
...
void Objf030_FieldInfo(Object *obj) {
   /* 平地/草地/繁み/荒地/水上/毒沼/溶岩/結界/障害物あり/侵入不可 */
   static s8 terrainText[10][11] = {"\x95\xbd\x92\x6e\x81\x40\x82\x4f\x81\x93",
                                    "\x91\x90\x92\x6e\x81\x40\x82\x54\x81\x93",
                                    "\x94\xc9\x82\xdd\x82\x50\x82\x54\x81\x93",
                                    "\x8d\x72\x92\x6e\x81\x40\x82\x4f\x81\x93",
                                    "\x90\x85\x8f\xe3\x82\x51\x82\x4f\x81\x93",
                                    "\x93\xc5\x8f\xc0\x81\x40\x82\x4f\x81\x93",
                                    "\x97\x6e\x8a\xe2\x81\x40\x82\x4f\x81\x93",
                                    "\x8c\x8b\x8a\x45\x82\x52\x82\x4f\x81\x93",
                                    "\x8f\xe1\x8a\x51\x95\xa8\x82\xa0\x82\xe8",
                                    "\x90\x4e\x93\xfc\x95\x73\x89\xc2\x81\x40"};
   ...
   switch (obj->state3) {
   case 0:
      DrawWindow(0x39, 368, 0, 88, 36, 8, 188, WBS_CROSSED, 0);
   ...
   case 1:
      if (OBJ.previousTerrain != gTerrainPtr[gMapCursorZ][gMapCursorX].s.terrain) {
         ...
         DrawText(372, 11, 25, 0, 0, terrainText[OBJ.previousTerrain]);
      }
...
void Objf013_BattleMgr(Object *obj) {
   ...
   case 13:
      ...
      switch (obj->state2) {
      case 0:
         DrawWindow(0x38, 0, 0, 160, 64, 50, 90, WBS_DRAGON, 0);
         // ENEMY TURN
         DrawSjisText(
             20, 24, 20, 0, 0,
   ...
   case 14:
      ...
      case 1:
         if (--OBJ.timer == 0) {
            DrawWindow(0x38, 0, 0, 176, 64, 50, 90, WBS_DRAGON, 0);
            // PLAYER TURN
            DrawSjisText(
                20, 24, 20, 0, 0,
