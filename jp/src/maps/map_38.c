/* Map 38's flood: Objf657_Map38_Floodgate runs the cutaway, then Objf655 lifts the gate,
 * Objf658 advances the water sheet and Objf654 washes away each non-CLASS_AIRMAN unit in the
 * 3x11 channel (TA_22). Objf659_Splash is the generic splash sprite, also used by Map 39. */
#include "common.h"
#include "object.h"
#include "graphics.h"
#include "field.h"
