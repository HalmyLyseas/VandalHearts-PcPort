/* Map 17's floodgate (Objf366 button -> Objf365 gate -> Objf368 draining water) and Map 19's
 * paired elevators (Objf357 driver, Objf355_356/358 platforms). Objf354_Map19_DebugElevators
 * is a developer toggle reading controller 2 with no spawn site, kept byte-exact. */
#include "common.h"
#include "object.h"
#include "graphics.h"
#include "field.h"
