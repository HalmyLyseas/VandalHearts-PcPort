...
#ifdef PC_PORT
         /* PC_PORT: the portrait's face/speak/blink sprite pointers can be NULL (a portrait
          * with no speak/blink sub-sprite). PSX discards the NULL store; guard each write --
          * same gated guard as the US tree (src/units/actor.c). */
