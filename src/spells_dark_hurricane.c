 ...
 * (unit_actor.c) -- a stray kept by address contiguity. Dispatched via gSpellsEx (see
 ...
 * spells_salamander.c) were emitted at the head of THIS TU's .rodata, ahead of the
