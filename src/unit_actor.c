 ...
 * the event-entity setup calls it shares with event_entities.c.
 *
 ...
 * lives in event_entities.c); ReserveSprite MoveImages one 48x48 cell into a strip slot
 * (both called from events.c). */
#include "common.h"
#include "object.h"
#include "window.h"
#include "units.h"
