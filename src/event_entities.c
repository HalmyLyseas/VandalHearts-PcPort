 ...
 * SetupEventEntity in unit_actor.c. state3 is the run state (0 create sprite, 1 fetch the
 ...
 * behind most per-scene effects in fx_event_scenes.c and the spells_* and maps_* units.
 *
...
/* unit_actor.c -- same TU before the split; the prototypes keep the retail narrow-arg
