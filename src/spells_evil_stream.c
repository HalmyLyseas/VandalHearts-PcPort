 ...
 * in spells_casting_main.c) plus EvilStream_RenderSkull. Dispatched via gSpellsEx (see
 * spells_casting_main.c). Objf325/326 are cut content (no spell, event, or code
...
/* spells_life_orb.c -- same TU before the split; prototype keeps the retail call codegen. */
