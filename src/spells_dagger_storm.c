 ...
 * gSpellsEx (see spells_casting_main.c). Cut content herein (no spell/event/code
 * dispatch): Objf082/083 (orbiting ember pair, homing explosion spark) and Objf321
 * (expanding explosion ring -- its only spawner, Objf734 in fx_event_scenes.c, is itself
 ...
 * Objf734 (fx_event_scenes.c) -- itself dispatched by nothing in retail, so this whole
