 ...
 * (Objf747_748/749 -- FX1 is in spells_fx_common2.c). Dispatched via gSpellsEx (see
 * spells_casting_main.c). Objf377 (breath head) is cut content: its breath phase is
 * signalled by no shipped head; suffixed _Unused, kept byte-exact.
 *
 * The head/quad initializer templates live in spells_dark_hurricane.c
...
/* Initializer templates address-locked in spells_dark_hurricane.c's .rodata (see the
