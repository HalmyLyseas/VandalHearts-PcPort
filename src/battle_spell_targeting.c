 ...
 *
 * Spawned by the unit action menu (Objf003_BattleActions, battle_0201b8.c) once the player
 ...
 * OBJF_UNIT_CASTING (Objf028, battle_013b94.c) at the caster's tile; cancel -> state 99.
 *
 ...
 * Objf015_TargetingAttack (battle_013b94.c), same grid + gSignal2 protocol.
 *
