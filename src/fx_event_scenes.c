 ...
 * event_entities.c): per-scene set pieces (Map44/Scn00, Map36/Scn74-75, Map48/Scn20,
...
/* fx_helpers.c -- same TU before the split; the prototypes keep the retail narrow-arg
