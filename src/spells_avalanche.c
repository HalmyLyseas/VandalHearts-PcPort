 ...
 * live in spells_casting_main.c, the stray boulder in spells_faerie.c) plus Roman Fire
 * FX2/FX3 (Objf344_345 -- FX1 is in spells_dark_fire.c) and the Objf339_349 rubble
 * spawner. Dispatched via gSpellsEx (see spells_casting_main.c). Noop_8008bca8 is an
